...
namespace Win32
{
    ...
    public class User
    {
        ...
        [DllImport("user32")] public static extern int EnumChildWindows(HWND hwndParent, EnumWindowsProc lpEnumFunc, int lParam);
        ...
        [DllImport("user32")] public static extern int EnumWindows(EnumWindowsProc lpEnumFunc, int lParam);
        ...
        [DllImport("user32")] public static extern bool SetLayeredWindowAttributes(HWND hwnd,int crKey,byte bAlpha,int dwFlags);
